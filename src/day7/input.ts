export const testDataPart1 = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const testDataPart2 = `shiny gold bags contain 2 dark red bags.
...
export const inputData = `wavy turquoise bags contain no other bags.
